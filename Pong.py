...
def keyPressed(direction):
    ...
    if direction.keysym == "Right" or direction.keysym == "d":
        ...
        if gameWinStatus == "Loading":
            gameWinStatus = "ongoing"
    if direction.keysym == "w":
        paddle1.width = paddle1.width + 5
    if direction.keysym == "s":
        paddle1.width = paddle1.width - 5
...
while True:
    ...
    if paddle1.width < 5:
        paddle1.width = 5
    if paddle1.width > winWidth:
        paddle1.width = winWidth
    ...
    for Brick in Bricks:
        Brick.draw()
    if len(Bricks) <= 0 and BrickHitNotification == False:
